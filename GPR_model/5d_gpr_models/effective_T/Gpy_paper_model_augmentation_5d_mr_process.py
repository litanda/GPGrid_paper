...
# the MLP kernel wins, so gmp1 kernel is 'MLP'
#kname = 'Mat32'
...
kname = 'MLP'
gdf1 = pd.read_csv(savedr + 'M1_MLP_gpm_.csv')
npy = savedr + 'M1_MLP_gpm_.npy'
gpm1 = gmk.load_a_gpm(df = gdf1, npy = npy, xcolumns = xcolumns, ycolumns = ycolumns, kname = kname)

offsets1 = dfv.copy()
gpp1 = pd.read_csv(savedr + 'M1_MLP_gpp_.csv')
offsets1 = pd.read_csv(savedr + 'M1_MLP_offsets_.csv')
