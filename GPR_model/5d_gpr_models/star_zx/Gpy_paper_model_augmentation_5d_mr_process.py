...
kname = 'Mat32'
gdf1 = pd.read_csv(savedr + 'M1_Mat32_gpm_.csv')
npy = savedr + 'M1_Mat32_gpm_.npy'
gpm1 = gmk.load_a_gpm(df = gdf1, npy = npy, xcolumns = xcolumns, ycolumns = ycolumns, kname = kname)
gpp1 = pd.read_csv(savedr + 'M1_Mat32_gpp_.csv')
offsets1 = pd.read_csv(savedr + 'M1_Mat32_offsets_.csv')
...
kname = 'RBF'
gdf2 = pd.read_csv(savedr + 'M2_RBF_gpm_.csv')
npy = savedr + 'M2_RBF_gpm_.npy'
gpm2 = gmk.load_a_gpm(df = gdf2, npy = npy, xcolumns = xcolumns, ycolumns = ycolumns, kname = kname)

gpp2 = pd.read_csv(savedr + 'M2_RBF_gpp_.csv')
offsets2 = pd.read_csv(savedr + 'M2_RBF_offsets_.csv')
